...
/**
 * @brief  Main program entry point - STSAFE-L010 Device authentication example
 * @details Demonstrates STSAFE-L010 device authentication process:
 *          - Initializes STSAFE-L010 device handler
 *          - Uses ST production CA certificate (SPL01)
